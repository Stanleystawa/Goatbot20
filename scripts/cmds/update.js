...
module.exports = {
	config: {
		...
		longDescription: {
			en: "Check for and install updates for lina bot.",
	...
	langs: {
		vi: {
			noUpdates: "Bạn đang sử dụng phiên bản mới nhất của GoatBot V2 (v1.2).",
		...
		en: {
			noUpdates: "You are using the latest version of Lina bot V2.2 (beta!).",
			updatePrompt: "You are using version %1. There is a new version %2. Do you want to update lina to the latest version?\n\nThe following files will be updated:\n%3%4\n\nSee details at https://github.com/ntkhang03/Goat-Bot-V2/commits/main\nReact to this message to confirm.",
			fileWillDelete: "\nThe following files/folders will be deleted:\n%1",
			andMore: " - ...and %1 more files",
			updateConfirmed: "Confirmed, updating...",
			updateComplete: "Update completed! lina will restart to apply changes."
		}
	},
