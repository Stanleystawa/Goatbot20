...
module.exports = {
  ...
  onStart: async function ({ message, prefix }) {
    ...
    const authorName = "FAHAD LYNX";
    const authorFB = "https://www.facebook.com/profile.php?id=100075127191325";
    ...
    const additionalText = "==𝙀́𝙙𝙞𝙩 𝙗𝙮 Gold Grilled  ㋡==";
